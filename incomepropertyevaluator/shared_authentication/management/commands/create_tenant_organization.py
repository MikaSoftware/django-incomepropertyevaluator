...
class Command(BaseCommand):
    ...
    def begin_processing(self, user, schema_name, name, alternate_name):
        ...
        organization = models.SharedOrganization.objects.create(
            owner=user,
        ...
        domain = models.SharedOrganizationDomain()
        domain.domain = organization.schema_name + '.' + Site.objects.get_current().domain
